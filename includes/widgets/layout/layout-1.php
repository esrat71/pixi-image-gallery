<div class="ele-inner-item ele-inner-col ele-hover-style-1">
    <div class="ele-image">
        <img src="<?php echo esc_url($settings['widget_image']['url'],'pixi-image-gallery');?>" alt="<?php echo esc_attr($settings['widget_title'],'pixi-image-gallery');?>" class="img-fluid">
    </div>
